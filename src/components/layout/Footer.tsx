    ...
    <footer className="bg-gray-100 border-t">
      <div className="container-custom pt-12 pb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Column 1 - About */}
          <div>
            <h3 className="text-xl font-semibold mb-4 text-esed-blue">ESED École</h3>
            ...
            <div className="flex space-x-4 mt-4">
              <a href="#" className="text-esed-blue hover:text-esed-orange transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/notre-approche" className="text-gray-600 hover:text-esed-orange transition-colors">
                  Notre approche
                </Link>
              </li>
              <li>
                <Link to="/catalogue" className="text-gray-600 hover:text-esed-orange transition-colors">
                  Catalogue des formations
                </Link>
              </li>
              <li>
                <Link to="/financement" className="text-gray-600 hover:text-esed-orange transition-colors">
                  Options de financement
                </Link>
              </li>
              <li>
                <Link to="/equipe" className="text-gray-600 hover:text-esed-orange transition-colors">
                  Notre équipe
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-600 hover:text-esed-orange transition-colors">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <p className="text-gray-600">
              ESED École est certifiée Qualiopi, garantissant la qualité de nos processus et de nos formations.
            </p>
          </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-600">
                  <a href="mailto:brice@esed-ecole.com" className="hover:text-esed-orange transition-colors">brice@esed-ecole.com</a>
                  <br />
        ...
        <div className="mt-12 pt-6 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              © {new Date().getFullYear()} ESED École. Tous droits réservés.
            </p>
